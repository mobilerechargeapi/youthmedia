<?php
include_once '../public/scrapping/libraries/dbConfig.php';
include_once '../public/scrapping/libraries/simple_html_dom.php';
...
function createThumbnail($thumbnail, $thumbCounter) {
	...
	$img = '../public/assets/images/posts/' . $thumbnailName;
